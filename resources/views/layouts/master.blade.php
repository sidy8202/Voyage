...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">See you Agency</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="btn btn-danger px-3" href="#"> Deconnexion</a>
    </div>
  </div>
</header>
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/vol">
              <span data-feather="file" class="align-text-bottom mt-5"></span>
              Les vols programmés
            </a>
          </li>
